...
urlpatterns = [
    ...
    path('lawyers/<int:pk>/update/',
         views.LawyerUpdateView.as_view(), name="lawyer_update"),
    path('lawyers/<int:pk>/delete/',
         views.LawyerDeleteView.as_view(), name="lawyer_delete"),
    ...
    path('cases/<int:pk>/update/',
         views.CaseUpdateView.as_view(), name="case_update"),
    path('cases/<int:pk>/delete/',
